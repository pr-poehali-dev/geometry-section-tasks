...
const TOPICS = ["Механика", "Оптика", "Термодинамика", "Электродинамика", "Квантовая физика"];
...
const THEORY_DATA = [
  {
    ...
    topic: "Механика",
    desc: "Три фундаментальных закона, описывающих движение тел и взаимодействие между ними.",
    readTime: "8 мин",
    icon: "Atom",
  },
  {
    ...
    desc: "Связь между напряжением, силой тока и сопротивлением в электрической цепи.",
    readTime: "5 мин",
    icon: "Zap",
  },
  {
    ...
    topic: "Оптика",
    desc: "Описание распространения волн и объяснение явлений отражения и преломления.",
    readTime: "10 мин",
    icon: "Eye",
  },
  {
    ...
    topic: "Термодинамика",
    desc: "Закон сохранения энергии применительно к тепловым процессам.",
    readTime: "7 мин",
    icon: "Flame",
  },
  {
    ...
    desc: "Явление вырывания электронов из вещества под действием света.",
    readTime: "9 мин",
    icon: "Sun",
  },
  {
    id: 6,
    title: "Второй закон Кеплера",
    topic: "Механика",
    desc: "Закон площадей: радиус-вектор планеты описывает равные площади за равные промежутки времени.",
    readTime: "6 мин",
    icon: "Globe",
  },
];
...
const TASKS_DATA = [
  {
    ...
    topic: "Механика",
    level: "Базовый",
    desc: "Найти ускорение тела, скользящего по наклонной плоскости с коэффициентом трения μ = 0.3.",
  },
  {
    id: 2,
    title: "Интерференция световых волн",
    topic: "Оптика",
    level: "Сложный",
    desc: "Определить ширину интерференционных полос на экране при заданных параметрах опыта.",
  },
  {
    id: 3,
    title: "Цикл Карно",
    topic: "Термодинамика",
    level: "Средний",
    desc: "Рассчитать КПД идеальной тепловой машины, работающей по циклу Карно.",
  },
  {
    id: 4,
    title: "Закон Кулона",
    topic: "Электродинамика",
    level: "Базовый",
    desc: "Найти силу взаимодействия двух точечных зарядов, расположенных на расстоянии r.",
  },
  {
    id: 5,
    title: "Уравнение де Бройля",
    topic: "Квантовая физика",
    level: "Сложный",
    desc: "Определить длину волны де Бройля для электрона с заданной кинетической энергией.",
  },
  {
    id: 6,
    title: "Маятник в вязкой среде",
    topic: "Механика",
    level: "Средний",
    desc: "Исследовать затухающие колебания математического маятника в среде с сопротивлением.",
  },
  {
    id: 7,
    title: "Линза и изображение",
    topic: "Оптика",
    level: "Базовый",
    desc: "Построить изображение предмета в тонкой собирающей линзе и найти его характеристики.",
  },
  {
    id: 8,
    ...
    topic: "Термодинамика",
    level: "Сложный",
    desc: "Рассчитать параметры газа после адиабатного расширения в цилиндре с поршнем.",
  },
];
...
const DRAWINGS_DATA = [
  {
    id: 1,
    title: "Сила и её составляющие",
    topic: "Механика",
    desc: "Разложение вектора силы на составляющие при движении по наклонной плоскости.",
    type: "Векторная диаграмма",
  },
  {
    id: 2,
    title: "Электрическое поле точечного заряда",
    topic: "Электродинамика",
    desc: "Силовые линии и эквипотенциальные поверхности точечного заряда.",
    type: "Схема поля",
  },
  {
    id: 3,
    title: "Ход лучей в линзе",
    topic: "Оптика",
    desc: "Построение изображения в собирающей и рассеивающей линзах.",
    type: "Оптическая схема",
  },
  {
    id: 4,
    title: "p-V диаграмма процессов",
    topic: "Термодинамика",
    desc: "Изотермный, изохорный и изобарный процессы на диаграмме p-V.",
    type: "График",
  },
];
